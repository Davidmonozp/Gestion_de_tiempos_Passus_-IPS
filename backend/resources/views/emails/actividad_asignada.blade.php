{{-- <h1>Cordial saludo, {{ $actividad->asignadoA->name }}</h1>
<p>Se te ha asignado una nueva actividad en el sistema.</p>
<ul>
    <li><strong>Actividad:</strong> {{ $actividad->nombre }}</li>
    <li><strong>Área:</strong> {{ $actividad->area->nombre }}</li>
    <li><strong>Estado:</strong> {{ $actividad->estado }}</li>
</ul>
<p>Por favor, ingresa al sistema para revisar los detalles.</p> --}}
...
<head>
    ...
    <title>Actividad Asignada: {{ $actividad->id }}</title>
    <style type="text/css">
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            <h1>¡Actividad Asignada para Su Gestión!</h1>

                            <p>Estimado(a) usuario(a) {{ $actividad->asignadoA->name }},</p>

                            <p>Se le ha asignado la siguiente actividad con el ID: {{ $actividad->id }}</p>
