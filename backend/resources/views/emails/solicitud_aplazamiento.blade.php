...
<head>
    ...
    <title>Solicitud de Aplazamiento: {{ $solicitud->id }}</title>
    <style type="text/css">
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    ...
                    <tr>
                        <td class="body-content">
                            <h1>¡Nueva Solicitud de Aplazamiento!</h1>

                            <p>Estimado(a) usuario(a) {{ $notifiable->nombre }},</p>

                            <p>Has recibido una nueva solicitud para aplazar una actividad</p>
